...
export function SwitchCommitteeButton({ nextPath = "/profile" }: { nextPath?: string }) {
  ...
  return (
    <button
      ...
      className="block w-full text-center py-3 rounded-lg border border-brand-navy/20 text-brand-navy font-medium hover:bg-white/5 active:bg-white/10 transition-colors disabled:opacity-50"
    >
