...
export function SmtAwardsRubricPanel() {
  return (
    <div className="space-y-6">
      <section className="rounded-xl border border-brand-navy/10 bg-logo-cyan/10 p-4 dark:border-white/10 dark:bg-white/5">
        ...
        <p className="mt-1 text-xs leading-relaxed text-brand-muted dark:text-discord-muted">
          Reference copy for Secretariat: award types, evaluation process, and full 1–8 band matrices (from the conference
          rubric). Scoring in InterMUN uses the same criterion keys where nominations are submitted.
        </p>
      </section>
      ...
      <RubricMatrix
        title="Chair report — overall"
        criteria={CHAIR_REPORT_OVERALL_RUBRIC}
        maxPoints={32}
      />
      ...
      <RubricMatrix
        ...
        criteria={BEST_COMMITTEE_RUBRIC}
        maxPoints={32}
      />
