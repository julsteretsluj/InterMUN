  ...
  return (
    <div className="marketing-shell mun-apple-site relative min-h-screen text-brand-navy">
      ...
      <header className="marketing-header sticky top-0 z-30 border-b-0">
        ...
        <div className="marketing-header-inner mx-auto grid max-w-6xl grid-cols-[1fr_auto] items-center gap-2 px-3 py-2.5 md:gap-3 md:px-5 lg:grid-cols-[1fr_auto_1fr]">
