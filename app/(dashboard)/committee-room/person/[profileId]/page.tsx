      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,280px)_minmax(0,1fr)] items-start">
        ...
        <div className="space-y-4 min-w-0">
          ...
          {canReadFullProfile && fullProfile ? (
            <section className="rounded-2xl border border-sky-400/20 bg-gradient-to-br from-sky-500/[0.1] via-brand-paper/50 to-emerald-500/[0.08] p-5 md:p-6 shadow-[0_12px_40px_-16px_rgba(0,0,0,0.45)]">
              <h2 className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-brand-muted mb-4">
                Account profile
              </h2>
              <dl className="grid gap-2 sm:grid-cols-2">
