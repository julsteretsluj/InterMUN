...
function applyAccent(hex,dark){var p=derive(hex,dark);r.style.setProperty("--accent",p.accent);r.style.setProperty("--accent-bright",p.bright);r.style.setProperty("--brand-accent",p.accent);r.style.setProperty("--brand-accent-bright",p.bright);r.style.setProperty("--clicky-blue",p.accent);r.style.setProperty("--clicky-blue-hover",p.bright);r.style.setProperty("--system-blue",p.accent);r.style.setProperty("--discord-blurple",p.accent);r.style.setProperty("--gold-text-bright",p.bright);r.style.setProperty("--brand-gold-text",p.bright);r.style.setProperty("--gold-text","color-mix(in srgb, "+p.accent+" 88%, var(--color-text))");}
