...
export const PREVIEW_SPEAKER_PANEL =
  "rounded-xl border border-[color-mix(in_srgb,var(--accent)_25%,#d4d4d8)] bg-[color-mix(in_srgb,var(--accent)_12%,#f4f4f5)] px-3 py-2.5 text-zinc-900";
export const PREVIEW_SPEAKER_NOW = "text-xs text-zinc-600";
export const PREVIEW_SPEAKER_NAME = "preview-speaker-name font-display text-base font-semibold text-zinc-900";
export const PREVIEW_SPEAKER_TIMER =
  "preview-speaker-timer font-mono text-sm font-semibold tabular-nums text-[var(--accent)]";
