  ...
  return (
    <Link
      ...
      aria-label={`${priority}. ${label}`}
        className={cn(
          "nav-priority-link discord-interactive-hover relative flex w-full min-w-0 items-center gap-3 rounded-[var(--radius-md)] py-2.5 pl-8 pr-3 text-sm transition-apple",
