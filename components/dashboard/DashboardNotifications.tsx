      ...
      {open ? (
        ...
        >
                  ...
                  <li key={n.id}>
                    <button
                      ...
                      className={cn(
                        ...
                        !n.read_at && "bg-violet-50/80 dark:bg-violet-950/25"
                      )}
                    >
                      ...
                      <span className="text-[0.65rem] font-medium text-violet-600 dark:text-violet-400">
                        Open →
                      </span>
                    </button>
                  </li>
          ...
          <div className="border-t border-slate-100 px-4 py-2 dark:border-zinc-800">
            <Link
              href="/chats-notes"
              className="text-xs font-medium text-slate-500 hover:text-violet-600 dark:text-zinc-400 dark:hover:text-violet-400"
