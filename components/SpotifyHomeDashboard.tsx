...
export function SpotifyHomeDashboard() {
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(circle at top left, rgba(29,185,84,0.22) 0%, rgba(10,10,10,0.92) 40%), radial-gradient(circle at bottom right, rgba(29,185,84,0.18) 0%, rgba(10,10,10,0.96) 45%), linear-gradient(135deg, #111111 0%, #0a0a0a 100%)",
